...
extern void ShowCardID(uchar *id);
extern void ShowCardType(uchar* type);
extern void Write_MFRC522(uchar addr, uchar val);
extern uchar Read_MFRC522(uchar addr);
extern void SetBitMask(uchar reg, uchar mask) ;
extern void ClearBitMask(uchar reg, uchar mask) ;
extern void AntennaOn(void);
extern void AntennaOff(void);
extern void MFRC522_Reset(void);
extern void MFRC522_Init(void);
extern uchar MFRC522_Request(uchar reqMode, uchar *TagType);
extern uchar MFRC522_ToCard(uchar command, uchar *sendData, uchar sendLen, uchar *backData, uint *backLen);
extern uchar MFRC522_Anticoll(uchar *serNum);
extern void CalulateCRC(uchar *pIndata, uchar len, uchar *pOutData);
extern uchar MFRC522_Write(uchar blockAddr, uchar *writeData);
extern void MFRC522_Halt(void);

//IO����
extern const int chipSelectPin;
extern const int NRSTPD;
