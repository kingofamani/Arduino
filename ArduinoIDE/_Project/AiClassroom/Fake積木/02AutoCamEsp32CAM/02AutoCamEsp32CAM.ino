//Generated Date: Sat, 21 Dec 2024 04:07:29 GMT
...
AdafruitIO_Feed *feedName_1734753697203 = io.feed("control-cam");
void handleMessage_1734753697203(AdafruitIO_Data *data) {
  //收到MQTT訊息後，拍照上傳Google雲端硬碟
  if (data->value() == "START_PLANT_CAM") {
    message = "plant";
  } else if (data->value() == "START_TRASH_CAM") {
    message = "trash";
  }
  SendStillToGoogleDrive(String("/macros/s/")+"xxxxxxxxxxxxxxxxxxxxxxxx"+String("/exec"), String("&myFoldername=")+urlencode("AiClassroom/images"), String("&myFilename=")+urlencode(message), String("&myLineType=")+"", String("&myToken=")+urlencode(""), String("&myUserID=")+urlencode(""), "&myFile=");
}

void setup()
{
  Serial.begin(115200);
  delay(10);Serial.begin(115200);
  ...
  adafruitio_connect();
  feedName_1734753697203->onMessage(handleMessage_1734753697203);
}
