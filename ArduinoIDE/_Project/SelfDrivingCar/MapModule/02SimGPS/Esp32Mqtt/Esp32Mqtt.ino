...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  // Serial.println(carX);
  // Serial.println(carY);
  // char x=(char)payload[1];
  // char y=(char)payload[3];

  //傳送至ESP32 GPS板
  msgXY[0] = (char)payload[1];
  msgXY[1] = (char)payload[3]; 
  msgXY[2] = '\0';
  Serial.println(msgXY);
  // delay(1000);  

  //char* a = (char)payload[1];
  //Serial.println(a);

  //Esp32GpsSerial.write((char)payload[1]);
  Esp32GpsSerial.write(msgXY);
}
...
void loop() {  
  ...
  // if(msgXY !=""){
  //   Esp32GpsSerial.write("123");
  //   delay(1000);
  // }
  // char* test = "tset";
  // Esp32GpsSerial.write(test);
  // delay(1000);
}