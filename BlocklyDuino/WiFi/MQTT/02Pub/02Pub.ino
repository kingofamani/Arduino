...
//HiveMQ Cluster URL
const char* mqtt_server = "xxxxxx.s2.eu.hivemq.cloud";
...
void setup() {
  ...
  //發佈
  mqttSendMsg = "王小明,PS5主機,1,1,3,5";
  Serial.print("發佈消息:");
  Serial.println(mqttSendMsg);
  client.publish(TOPIC_GOODS, mqttSendMsg);
  Serial.println(String(TOPIC_GOODS)+"已發佈消息成功！請開啟https://console.hivemq.cloud/ 來測試！");
}
